...
define([], function(){
  Box.Application.addService('mapSvgOverlay', function(application) {
    ...
    factory.getSvgOverlay = function(){
        ...
        let map, leftTop, rightTop, leftBottom;
        /**
        ...
        function SvgOverlay(options) {
          ...
          this.container_.setAttribute( "class", "masterplan-svg");
        ...
        SvgOverlay.prototype.getSvgWidthHeight = function(){
            let object = {},
            point1 = _latLngToPixelCordinates(leftTop[0], leftTop[1]),
            point2 = _latLngToPixelCordinates(rightTop[0], rightTop[1]),
            point3 = _latLngToPixelCordinates(leftBottom[0], leftBottom[1]);
        ...
        var _latLngToPixelCordinates = function(latitude, longitude){
            ...
            createPixelCoordinates = function(){
              ...
              worldCoordinate = projection.fromLatLngToPoint(latLngObj),
        ...
        SvgOverlay.prototype.draw = function() {
          ...
          let projection = this.getProjection(), style = this.container_.style;

          if (!projection || !this.svg_) {
            return;
          }

          let upperLeftPoint =  projection.fromLatLngToDivPixel(new google.maps.LatLng(leftTop[0], leftTop[1]));
          let svgWidthHeight = this.getSvgWidthHeight();
